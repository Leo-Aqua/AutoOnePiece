...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_8.setGeometry(QRect(10, 120, 111, 21))
        self.maxOutputSpinBox = QSpinBox(self.groupBox)
        self.maxOutputSpinBox.setObjectName(u"maxOutputSpinBox")
        self.maxOutputSpinBox.setGeometry(QRect(130, 120, 51, 22))
        self.maxOutputSpinBox.setMinimum(1)
        self.maxOutputSpinBox.setMaximum(100)
        ...
        QWidget.setTabOrder(self.maxSearchSpinBox, self.maxOutputSpinBox)
        QWidget.setTabOrder(self.maxOutputSpinBox, self.searchButton)
...
#if QT_CONFIG(tooltip)
        self.label_8.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>The maximum ammount of videos to be outputted</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Max. output Videos", None))
#if QT_CONFIG(tooltip)
        self.maxOutputSpinBox.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>The maximum ammount of videos to be outputted</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
